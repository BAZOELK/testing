...
###########- COLOR CODE -##############
colornow=$(cat /etc/tester/theme/color.conf)
export NC="\e[0m"
export YELLOW='\033[0;33m';
export RED="\033[0;31m" 
export COLOR1="$(cat /etc/tester/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/tester/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"                    
###########- END COLOR CODE -##########
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/BAZOELK/santai/aja/diwarung | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/BAZOELK/santai/aja/diwarung | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
echo "IP=$host" > /var/lib/tester-pro/ipvps.conf
echo ""
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/BAZOELK/testing/bos/update/update.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/XolvaID/ip/main/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/XolvaID/ip/main/versi)
if [ "$Isadmin" = "ON" ]; then
